...
from lvc.checkpoint import DetectionCheckpointer
from lvc.engine.hooks import EvalHookFsdet
...
from lvc.modeling import build_model
...
def default_setup(cfg, args):
    ...
    setup_logger(output_dir, distributed_rank=rank, name="lvc")
...
class DefaultTrainer(SimpleTrainer):
    ...
    def resume_or_load(self, resume=True):
        ...
        if resume and self.checkpointer.has_checkpoint():
            ...
            # The checkpoint stores the training iteration that just
            # finished, thus we start
            # at the next iteration (or iter zero if
    ...
    def build_model(cls, cfg):
        ...
        It now calls :func:`lvc.modeling.build_model`.
    ...
    def build_optimizer(cls, cfg, model):
        ...
        It now calls :func:`lvc.solver.build_optimizer`.
    ...
    def build_lr_scheduler(cls, cfg, optimizer):
        """
        It now calls :func:`lvc.solver.build_lr_scheduler`.
    ...
    def build_train_loader(cls, cfg):
        ...
        """
        if cfg.INPUT.MOSAIC:
            return build_detection_train_mosaic_loader(cfg)
    ...
    def build_test_loader(cls, cfg, dataset_name):
        ...
        It now calls :func:`lvc.data.build_detection_test_loader`.
        Overwrite it if you'd like a different data loader.
        """
