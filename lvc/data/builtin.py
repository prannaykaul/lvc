...
def register_all_coco(root="datasets"):
    ...
    METASPLITS = [
        ...
        ("coco_unlabeled_all", "coco/unlabeled2017", "coco/annotations/image_info_unlabeled2017.json"),
    ]
    ...
    METASPLITS.append(("coco_trainval_all_30shot_seed1_dropped", "coco/trainval2014", ""))
...
def register_all_pascal_voc(root="datasets"):
    ...
    for name, dirname, split, keepclasses, sid in METASPLITS:
        ...
        MetadataCatalog.get(name).evaluator_type = "pascal_voc"
        MetadataCatalog.get(name).image_root = os.path.join(root, dirname)
        MetadataCatalog.get(name).json_file = os.path.join(root, 'voc', '{}.json'.format(name))


# Register them all under "./datasets"
root = os.getenv("DETECTRON2_DATASETS", "datasets")
if "coco_test_all" not in DatasetCatalog._REGISTERED:
    register_all_coco(root=root)
# register_all_lvis()
register_all_pascal_voc(root=root)
